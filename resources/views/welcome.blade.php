    ...
    <div
      ...
      <div class="mx-auto max-w-7xl p-6 lg:p-8">
        <div class="flex justify-center">
          <svg class="h-16 w-auto bg-gray-100 dark:bg-gray-900" fill="none"
            viewBox="0 0 62 65" xmlns="http://www.w3.org/2000/svg">
            <path
            ...
            <a class="duration-250 flex scale-100 rounded-lg bg-white from-gray-700/50 via-transparent p-6 shadow-2xl shadow-gray-500/20 transition-all focus:outline focus:outline-2 focus:outline-red-500 motion-safe:hover:scale-[1.01] dark:bg-gray-800/50 dark:bg-gradient-to-bl dark:shadow-none dark:ring-1 dark:ring-inset dark:ring-white/5"
              ...
              <div>
                <div
                  ...
                  <svg class="h-7 w-7 stroke-red-500" fill="none"
                ...
                <p
                  ...
                  the framework. Whether you
                  are a newcomer or have prior experience with Laravel, we
                  recommend reading our
                  documentation from beginning to end.
                </p>
              </div>

              <svg class="mx-6 h-6 w-6 shrink-0 self-center stroke-red-500"
            ...
            <a class="duration-250 flex scale-100 rounded-lg bg-white from-gray-700/50 via-transparent p-6 shadow-2xl shadow-gray-500/20 transition-all focus:outline focus:outline-2 focus:outline-red-500 motion-safe:hover:scale-[1.01] dark:bg-gray-800/50 dark:bg-gradient-to-bl dark:shadow-none dark:ring-1 dark:ring-inset dark:ring-white/5"
              ...
              <div>
                ...
                <p
                  ...
                  and JavaScript
                  development. Check them out, see for yourself, and massively
            ...
            <a class="duration-250 flex scale-100 rounded-lg bg-white from-gray-700/50 via-transparent p-6 shadow-2xl shadow-gray-500/20 transition-all focus:outline focus:outline-2 focus:outline-red-500 motion-safe:hover:scale-[1.01] dark:bg-gray-800/50 dark:bg-gradient-to-bl dark:shadow-none dark:ring-1 dark:ring-inset dark:ring-white/5"
              ...
              <div>
                ...
                <p
                  ...
                  and most important news in the Laravel ecosystem, including
                  new package releases and
                  tutorials.
                </p>
              </div>
            ...
            <div
              ...
              <div>
                ...
                <p
                  ...
                  <a class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                    href="https://vapor.laravel.com">Vapor</a>,
                  <a class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                    href="https://nova.laravel.com">Nova</a>,
                  and <a
                    class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                    href="https://envoyer.io">Envoyer</a>
                  help you take your projects to the next level. Pair them with
                  powerful open source
                  libraries like <a
                    class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                    href="https://laravel.com/docs/billing">Cashier</a>,
                  <a class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                    href="https://laravel.com/docs/dusk">Dusk</a>,
                  <a class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                    href="https://laravel.com/docs/broadcasting">Echo</a>,
                  <a class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                    href="https://laravel.com/docs/horizon">Horizon</a>,
                  <a class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                    href="https://laravel.com/docs/sanctum">Sanctum</a>,
                  <a class="underline hover:text-gray-700 focus:rounded-sm focus:outline focus:outline-2 focus:outline-red-500 dark:hover:text-white"
                    href="https://laravel.com/docs/telescope">Telescope</a>,
                  and more.
                </p>
              </div>
            </div>
        ...
        <div
          ...
          <div
            class="text-center text-sm text-gray-500 dark:text-gray-400 sm:ml-0 sm:text-right">
