...
<<<<<<< HEAD
            <label for="ci_repr">C.I</label>
            <input type="number" id="registerCedula" placeholder="Cédula" name="ci_repr" maxlength="8" pattern="[0-9]+" title="Número de cédula invalido, mínimo tener 8 caracteres" required>
          </div>
...
<<<<<<< HEAD
              <label for="nom_repr">Nombres</label>
...
<<<<<<< HEAD
              <label for="edo_repr">Estado de nacimiento</label>
              <input type="text" id="registerEstado" placeholder="Estado de nacimiento" name="estado" required>
=======
...
<<<<<<< HEAD
              ...
              <input type="text" id="registerLugar" placeholder="Lugar de nacimiento" name="lugar" required>
=======
...
<<<<<<< HEAD
              <label for="gen_repr">Sexo del representante</label>
=======
              <label for="gen_repr">Género:</label>
>>>>>>> c580a3aae25a2245f2a4a5f4af4ca6962248e4d6
            ...
            <div class="contenedor1">
              ...
              <input type="text" id="registerDireccion" placeholder="Dirección" name="direccion" required>
            </div>
            <br>
            <div class="row">
