...
$momentos_result = $conexion->query('SELECT id, CONCAT("Lapso", numero_momento) AS momento FROM momentos');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt_asignacion = $conexion->prepare("INSERT INTO asignaciones (id_profesor, id_materia, id_momento, id_nivel_estudio, id_seccion) VALUES (?, ?, ?, ?, ?)");
    $stmt_asignacion->bind_param("iiiii", $id_profesor, $id_materia, $id_momento, $id_nivel_estudio, $id_seccion);
    ...
    <div class="row mx-0 justify-content-center pb-5">
       <form  class="card col-md-5 py-4" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <?php endif; ?>
            ...
            <label class="ms-2" for="id_momento">
