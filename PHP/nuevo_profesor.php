  ...
  <form class="card col-md-8 py-4" method="post" action="./guardar_profesor.php">
    ...
    <div class="card-body row">
      <div class="col-md-12 form-floating mb-3">
        <input class="form-control" type="number" min="10000000" max="31000000" placeholder=" " name="cedula" required />
        <label class="ms-2">
      ...
      <div class="col-md-6 form-floating mb-3">
        <input type="tel" class="form-control" placeholder=" " name="telefono" required />
        <label class="ms-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div class="col-md-6 form-floating mb-3">
        <textarea class="form-control" placeholder=" " name="direccion" required></textarea>
        <label class="ms-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
