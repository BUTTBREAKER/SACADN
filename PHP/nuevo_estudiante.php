  ...
  <div class="contenedor">
    <form class="formulario" method="post" action="./guardar_estudiante.php" autocomplete="off">
     ...
     <h4 class="title1">Inscripción de estudiante</h4>
          ...
          <input type="number-tlf" id="registerCedula" placeholder="Cédula" name="cedula" required>
               </div>

        <div class="contenedor1">
              <i><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path fill="#000000" d="M18 10.5V6l-2.11 1.06A3.999 3.999 0 0 1 12 12a3.999 3.999 0 0 1-3.89-4.94L5 5.5L12 2l7 3.5v5zM12 9l-2-1c0 1.1.9 2 2 2s2-.9 2-2zm2.75-3.58L12.16 4.1L9.47 5.47l2.6 1.32zM12 13c2.67 0 8 1.33 8 4v3H4v-3c0-2.67 5.33-4 8-4m0 1.9c-3 0-6.1 1.46-6.1 2.1v1.1h12.2V17c0-.64-3.13-2.1-6.1-2.1"/></svg></i>
              <label for="nombre">Nombres</label>
            <input type="text" id="registerNombreCompleto" placeholder="Nombres" name="nombre" title="Por favor llenar los campos vacíos" required>
          </div>
          ...
          <input type="date" id="registerFecha_nac" placeholder="dia/mes/año" name="fecha_nacimiento" required>
          ...
          <input type="text" id="estudiante" placeholder="Estado de nacimiento" name="estado_nacimiento" required>
               </div>
          ...
          <input type="text" id="registerLugar" placeholder="lugar de nacimiento" name="lugar_nacimiento" required>
               </div>
         ...
         <div class="contenedor1">
              ...
              <label for="id_representante">Cedula del representante:</label>
              <select id="Cedula" name="id_representante" required>
