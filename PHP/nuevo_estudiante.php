  ...
  <div class="contenedor">
    <form class="formulario" method="post" action="./guardar_estudiante.php" autocomplete="off">
     ...
     <h4 class="title1">Inscripción de estudiante</h4>
          ...
          <input type="number-tlf" id="registerCedula" placeholder="Cédula" name="ci_est" required>
               </div>
        ...
        <div class="contenedor1">
          ...
          <input type="text" id="estudiante" placeholder="Estado de nacimiento" name="estado" required>
               </div>
