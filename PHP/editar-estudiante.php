...
if ($_POST) {
  $sql = <<<sql
  UPDATE representantes SET ci_repr = ?, nombre_completo = ?, apellido = ?,
  fecha_nac = ?, estado = ?, lugar = ?, genero = ?, telefono = ?, direccion = ?
  WHERE ci_repr = ?
  sql;
...
$sql = <<<sql
  ...
  fecha_nac AS fecha_nacimiento, estado as estado_nacimiento,
  lugar AS lugar_nacimiento, genero AS sexo, fech_est AS fecha_registro
  FROM estudiantes
  WHERE ci_est = ?
sql;
      ...
      <form class="formulario" method="post" autocomplete="off">
        <div class="input-contenedor">
          ...
          <div class="contenedor1">
            <i>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                <path fill="#000000" d="M18 10.5V6l-2.11 1.06A3.999 3.999 0 0 1 12 12a3.999 3.999 0 0 1-3.89-4.94L5 5.5L12 2l7 3.5v5zM12 9l-2-1c0 1.1.9 2 2 2s2-.9 2-2zm2.75-3.58L12.16 4.1L9.47 5.47l2.6 1.32zM12 13c2.67 0 8 1.33 8 4v3H4v-3c0-2.67 5.33-4 8-4m0 1.9c-3 0-6.1 1.46-6.1 2.1v1.1h12.2V17c0-.64-3.13-2.1-6.1-2.1" />
              </svg>
            </i>
            <label for="ci_est">C.I</label>
            <input type="number" value="<?= $estudiante['cedula'] ?>" id="registerCedula" placeholder="Cédula" name="ci_est" maxlength="8" pattern="[0-9]+" title="Número de cédula invalido, mínimo tener 8 caracteres" required />
          </div>
          <div class="contenedor1">
            <i>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
            ...
            <input value="<?= $estudiante['nombres'] ?>" id="registerNombreCompleto" placeholder="Nombres" name="nombre_completo" title="Por favor llenar los campos vacíos" required />
          </div>
          ...
          <div class="contenedor1">
            ...
            <input value="<?= $estudiante['apellidos'] ?>" id="registerApellido" placeholder="Apellidos" name="apellido" title="Por favor llenar los campos vacíos" required />
          </div>
          ...
          <div class="contenedor1">
            ...
            <input type="date" value="<?= $estudiante['fecha_nacimiento'] ?>" id="registerFecha_nac" placeholder="dia/mes/año" name="fecha_nac" required />
            ...
            <div class="contenedor1">
              ...
              <input value="<?= $estudiante['estado_nacimiento'] ?>" id="registerEstado" placeholder="Estado de nacimiento" name="estado" title="Por favor llenar los campos vacíos" required />
            </div>
            <div class="contenedor1">
              <i>
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
              ...
              <input type="text" value="<?= $estudiante['lugar_nacimiento'] ?>" id="registerLugar" placeholder="Lugar de nacimiento" name="lugar" title="Por favor llenar los campos vacíos" required />
            </div>
            <div class="contenedor1">
              <i>
              ...
              <label for="genero">Sexo del estudiante</label>
              <select id="estudiante" name="genero" required>
                <option value="">Selecciona una opción</option>
                <option selected="<?= $estudiante['sexo'] === 'masculino' ?>" value="masculino">
                  Masculino
                </option>
                <option selected="<?= $estudiante['sexo'] === 'femenino' ?>" value="femenino">
                  Femenino
                </option>
              </select>
            </div>
            ...
            <div class="contenedor1">
              ...
              <label for="ci_repr">Cedula del representante:</label>
              <select id="Cedula" name="ci_repr" required>
                <option value="">Selecciona una Cedula</option>
                <option selected="<?= $estudiante['sexo'] === 'masculino' ?>" value="masculino">
                  Masculino
                </option>
                <option selected="<?= $estudiante['sexo'] === 'femenino' ?>" value="femenino">
                  ...
                  <form class="formulario" method="post" autocomplete="off">
                    <div class="input-contenedor">
                      ...
                      <div class="contenedor1">
                        ...
                        <input type="number" value="<?= $representante['cedula'] ?>" id="registrarCedula" placeholder="Cédula" name="ci_repr" maxlength="8" pattern="[0-9]+" title="Número de cédula invalido, mínimo tener 8 caracteres" required>
                      </div>
                      <div class="contenedor1">
                        <i><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 
                        ...
                        <input type="text" value="<?= $representante['apellidos'] ?>" id="registerApellido" placeholder="Apellidos" name="apellido" required>
                      </div>
                      <div class="contenedor1">
                        ...
                        <input type="date" value="<?= $representante['fecha_nacimiento'] ?>" id="registerFecha_nac" placeholder="dia/mes/año" name="fecha_nac" required>
                        <div class="contenedor1">
                        ...
                        <div class="contenedor1">
                          ...
                          <input type="text" value="<?= $representante['lugar_nacimiento'] ?>" id="registerLugar" placeholder="Lugar" name="lugar" required>
                        </div>
                        <div class="contenedor1">
                          <i><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 32 32">
                              <path fill="#000000" d="M22 3v2h3.563l-3.375 3.406A6.962 6.962 0 0 0 18 7c-1.87 0-3.616.74-4.938 2.063a6.94 6.94 0 0 0 .001 9.875c.87.87 1.906 1.495 3.062 1.812c.114-.087.242-.178.344-.28a3.45 3.45 0 0 0 .874-1.532a4.906 4.906 0 0 1-2.875-1.407C13.524 16.588 13 15.336 13 14s.525-2.586 1.47-3.53C15.412 9.523 16.664 9 18 9s2.587.525 3.53 1.47A4.956 4.956 0 0 1 23 14c0 .865-.245 1.67-.656 2.406c.096.516.156 1.058.156 1.594c0 .498-.042.99-.125 1.47c.2-.163.378-.348.563-.532C24.26 17.614 25 15.87 25 14c0-1.53-.504-2.984-1.406-4.188L27 6.438V10h2V3zm-6.125 8.25c-.114.087-.242.178-.344.28c-.432.434-.714.96-.874 1.533c1.09.14 2.085.616 2.875 1.406c.945.943 1.47 2.195 1.47 3.53s-.525 2.586-1.47 3.53C16.588 22.477 15.336 23 14 23s-2.587-.525-3.53-1.47A4.948 4.948 0 0 1 9 18c0-.865.245-1.67.656-2.406A8.789 8.789 0 0 1 9.5 14c0-.498.042-.99.125-1.47c-.2.163-.377.348-.563.533C7.742 14.384 7 16.13 7 18c0 1.53.504 2.984 1.406 4.188L6.72 23.875l-2-2l-1.44 1.406l2 2l-2 2l1.44 1.44l2-2l2 2l1.405-1.44l-2-2l1.688-1.686A6.932 6.932 0 0 0 14 25c1.87 0 3.616-.74 4.938-2.063C20.26 21.616 21 19.87 21 18s-.74-3.614-2.063-4.938c-.87-.87-1.906-1.495-3.062-1.812" />
                            </svg></i>
                          <label for="gen_repr">Género del representante:</label>
                          <select id="genero" name="genero" required>
                            <option value="">Selecciona una opción</option>
                            <option selected="<?= $representante['sexo'] === 'masculino' ?>" value="masculino">Masculino</option>
                            <option selected="<?= $representante['sexo'] === 'femenino' ?>" value="femenino">Femenino</option>
                          </select>
                        </div>
                        <div class="contenedor1">
                          <i> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                          ...
                          <input type="number-tlf" value="<?= $representante['telefono'] ?>" id="registerTelefono" placeholder="Teléfono" name="telefono" required>
                        </div>
                        <div class="contenedor1">
                          <i><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                          ...
                          <input id="registerDireccion" value="<?= $representante['direccion'] ?>" placeholder="Dirección" name="direccion" required>
                        </div>
                        <br>
                        <div class="row">
