    ...
    <form class="formulario" method="post" action="./guardar_profesor.php" autocomplete="off">
     ...
     <h4 class="title1">Nuevo registro de  Profesor</h4>
        ...
        <div class="contenedor1">
          ...
          <input type="text" id="profesor" placeholder="Nombre Completo" name="nombre_completo" required>
               </div>
          ...
          <input type="text" id="profesor" placeholder="Estado" name="estado" required>
               </div>
          ...
          <input type="text" id="profesor" placeholder="Lugar" name="lugar" required>
               </div>
